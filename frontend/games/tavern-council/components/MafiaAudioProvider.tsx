...
import type { TavernCouncilPhase } from '../types';

interface MafiaAudioProviderProps {
  phase: TavernCouncilPhase | undefined;
...
function phaseCue(ctx: AudioContext, phase: TavernCouncilPhase) {
  if (phase === 'night') {
...
export default function MafiaAudioProvider({
  ...
  const lastPhase = useRef<TavernCouncilPhase | undefined>(undefined);
