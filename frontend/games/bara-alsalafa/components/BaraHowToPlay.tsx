...
const STEPS = [
	...
	},
	{
		icon: Trophy,
		title: "الفوز",
		body: "يُحدد المضيف عدد جولات المباراة (3 أو 5 أو 7) وتُلعب كلها. بعد الجولة الأخيرة، من حقق انتصارات جولات أكثر يفوز (الداخلون مقابل برا السالفة). النقاط تُستخدم عند التعادل.",
	},
] as const;
